...
function GerenciarPedidos() {
  ...
  return (
    <div className='flex h-screen pt-16 mt-3 '>
      <Sidebar/>
        ...
        <div className='flex flex-col p-0'>
          ...
          <div className='flex flex-col text-secondary'>
            ...
            <div className='cursor-pointer flex justify-between items-center bg-gray-300 hover:bg-gray-300 py-3 px-4  border-l-4 border-orange-100'>
              ...
              <button className='bg-orange-500 text-white py-0.5 px-5 w-fit h-fit rounded-full'>0 min</button>
            </div>
            ...
            <div className='cursor-pointer flex justify-between items-center py-3 px-4 hover:bg-gray-300 border-b-2'>
              ...
              <button className='bg-orange-500 text-white py-0.5 px-5 w-fit h-fit rounded-full'>5 min</button>
            </div>
            ...
            <div className='cursor-pointer flex justify-between items-center py-3 px-4 hover:bg-gray-300 border-b-2'>
              ...
              <button className='bg-orange-500 text-white py-0.5 px-5 w-fit h-fit rounded-full'>9 min</button>
            </div>
            ...
            <div className='cursor-pointer flex justify-between items-center py-3 px-4 hover:bg-gray-300 border-b-2'>
              ...
              <button className='bg-orange-500 text-white py-0.5 px-5 w-fit h-fit rounded-full'>2 min</button>
            </div>
      ...
      <div className='flex  flex-col w-9/12 mx-auto mt-3 p-5 gap-10'>
        ...
        <div className='flex items-center gap-4'>
          <span className='text-2xl text-secondary_3_variant'>Pedido #4020</span>
          <div className='w-2 h-2 rounded-full bg-secondary_3'></div>
          <span className='text-2xl text-secondary_3_variant'>Feito às 14:13</span>
        </div>
        ...
        <div className='flex gap-8 items-center w-full bg-white rounded-md px-8 py-5 '>
          ...
          <div className='flex flex-col gap-3'>
            <span className='text-secondary_1'>Av. do General Manoel Rabelo, 798, Vila Yara - Recife/PE - CEP 52891-355</span>
          </div>
        </div>
        ...
        <div className='flex gap-16 ml-auto'>
            <button onClick={() => { navigate('') }} className='flex items-center font-extrabold text-white text-2xl bg-atention_02 hover:bg-amber-700 transition-opacity rounded-2xl px-20 p-3'>
              Rejeitar
            </button>
            <button onClick={() => { navigate('') }} className=' flex items-center font-extrabold text-white text-2xl rounded-2xl px-20 bg-secondary_1 hover:bg-secondary_2'>
              Confirmar
            </button>
