...
function NovaCategoria ({ onClose })  {
  return (
    <div className="fixed inset-0  bg-opacity-75 flex items-center justify-center">
      <div className="bg-gradient-to-t from-[#1F2026] via-black to-[#37383F] p-6 rounded-lg shadow-lg w-11/12 md:w-2/3 lg:w-1/2">
        ...
        <div className="flex justify-end mt-6">
          <button className="bg-secondary_3 hover:bg-secondary_3_variant text-white text-xl font-bold py-2 px-4 rounded-2 mr-6 w-48">
            Cancelar
          </button>
          <button className="bg-secondary_1 hover:bg-secondary_2 text-white text-xl font-bold py-2 px-4 rounded ml-6 w-48">
            Criar Categoria
          </button>
        </div>
      </div>
